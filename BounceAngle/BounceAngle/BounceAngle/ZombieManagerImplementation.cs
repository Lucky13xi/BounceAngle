...
namespace BounceAngle
{
    class ZombieManagerImplementation : ZombieManager
    {
        ...
        public void draw(SpriteBatch spriteBatch)
        {
            ...
            {
                spriteBatch.Draw(zombie.getTexture(), zombie.getCurrentLocation() + zombie.getOffset(), null, Color.White, zombie.getRotation(), new Vector2(zombie.getTexture().Width / 2, zombie.getTexture().Height / 2),0.5f, SpriteEffects.None, 0f);
