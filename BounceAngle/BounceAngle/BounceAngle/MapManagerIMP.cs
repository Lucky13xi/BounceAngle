...
namespace BounceAngle
{
    class MapManagerIMP : MapManager
    {
        ...
        public void LoadMap(ContentManager Content)
        {
            ...
            addBuilding(new BuildingIMP(new BuildingDataIMP(buildingCounter++, new Vector2(360, 340), false, Content.Load<Texture2D>("Images//mainStreet0"), 5, 0, 1, "Main Street Strip Mall", 2, 4, false, new Vector2(0.5f, 1))));
            ...
            addBuilding(new BuildingIMP(new BuildingDataIMP(buildingCounter++, new Vector2(-275, 300), false, Content.Load<Texture2D>("Images//apartments3"), 0, 1, 4, "Dirty End Motel", 0, 5, false, new Vector2(0.5f, 1))));
            addBuilding(new BuildingIMP(new BuildingDataIMP(buildingCounter++, new Vector2(-610, 330), false, Content.Load<Texture2D>("Images//apartments1"), 7, 2, 2, "Dark Night Co-op", 0, 4, false, new Vector2(0, 0.5f))));
            ...
            addBuilding(new BuildingIMP(new BuildingDataIMP(buildingCounter++, new Vector2(75, 350), false, Content.Load<Texture2D>("Images//lawsociety0"), 10, 0, 4, "Creaky Court House", 0, 7, false, new Vector2(0.5f, 1))));
            addBuilding(new BuildingIMP(new BuildingDataIMP(buildingCounter++, new Vector2(-350, 600), false, Content.Load<Texture2D>("Images//warehouse1"), 0, 0, 3, "Silent Storage", 0, 2, false, new Vector2(0.5f, 0))));
            addBuilding(new BuildingIMP(new BuildingDataIMP(buildingCounter++, new Vector2(1100, 600), false, Content.Load<Texture2D>("Images//warehouse1"), 0, 0, 3, "El Cheapo's Discount Lingerie", 0, 2, false, new Vector2(0.5f, 0))));
            addBuilding(new BuildingIMP(new BuildingDataIMP(buildingCounter++, new Vector2(1200, 600), false, Content.Load<Texture2D>("Images//warehouse1"), 0, 0, 3, "El Cheapo's Discount Swimware", 0, 2, false, new Vector2(0.5f, 0))));
