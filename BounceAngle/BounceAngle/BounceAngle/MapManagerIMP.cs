...
namespace BounceAngle
{
    class MapManagerIMP : MapManager
    {
        ...
        public void LoadMap(ContentManager Content)
        {
            ...
            addBuilding(new BuildingIMP(new BuildingDataIMP(buildingCounter++, new Vector2(975, 275), false, Content.Load<Texture2D>("Images//factory0"), 0, 4, 1, "ACME Industrial", 0, 6, false, new Vector2(1.1f, 0.5f))));
            ...
            addBuilding(new BuildingIMP(new BuildingDataIMP(buildingCounter++, new Vector2(-275, 0), false, Content.Load<Texture2D>("Images//apartments3"), 0, 1, 4, "Dirty End Motel", 0, 5, false, new Vector2(0.5f, 1.1f))));
            ...
            addBuilding(new BuildingIMP(new BuildingDataIMP(buildingCounter++, new Vector2(1400, 600), false, Content.Load<Texture2D>("Images//warehouse1"), 0, 0, 3, "El Cheapo's Discount Lingerie", 0, 2, false, new Vector2(0.5f, -0.1f))));
            ...
            addBuilding(new BuildingIMP(new BuildingDataIMP(buildingCounter++, new Vector2(60,-100), false, Content.Load<Texture2D>("Images//apartments2"), 5, 0, 2, "FunTimes Rental Suits", 2, 4, false, new Vector2(-0.1f, 0.5f))));
